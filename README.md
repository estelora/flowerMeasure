...
This is currently being set up for Continuous Integration with Jenkins, still a work in progress.

*Original repository can be found: https://github.com/flower-patch
